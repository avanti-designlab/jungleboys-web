...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-full border-2 border-white text-white transition-transform duration-200 hover:scale-110"
    >
      {dark ? (
        /* sun */
