...
// Two choices: Accept All, or Necessary Only (strictly-necessary storage — age
// gate, theme, this choice — cannot be declined; it is what makes the site
// function). Analytics (GA4, Phase 1+) must check
// localStorage 'jb-cookie-consent' === 'accepted' before initializing.
  ...
  return (
    ...
    >
      <p className="text-[11px] leading-relaxed text-white/70">
        We use cookies to improve your experience and analyze traffic. Necessary
        cookies keep the site working (age verification, your preferences).{' '}
      ...
      <div className="mt-3 flex gap-2">
        <button
          ...
          className="cursor-pointer rounded-full bg-[var(--color-accent)] px-4 py-2 text-[11px] font-bold uppercase tracking-wider text-[var(--color-on-accent)] transition-colors duration-300 hover:bg-white"
