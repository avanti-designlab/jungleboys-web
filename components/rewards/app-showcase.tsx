...
export default function AppShowcase() {
  ...
  const pill = (label: string, side: 'left' | 'right', i: number) => (
    <li
      ...
      className={`mx-auto w-fit whitespace-pre-line rounded-full bg-[#181818] px-7 py-4.5 text-center text-sm font-extrabold uppercase tracking-wide text-white lg:mx-0 shadow-[0_0_24px_rgba(254,207,14,0.12)] ring-1 ring-white/15 will-change-transform md:text-base ${
