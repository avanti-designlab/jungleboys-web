...
const STRUCTURED: Record<string, StoreAddressHours> = {
  ...
  'st-petersburg': { street: '4500 4th St N', city: 'St. Petersburg', zip: '33703', hoursSpec: [{ days: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'], opens: '08:30', closes: '20:30' }, { days: ['Sunday'], opens: '10:00', closes: '18:00' }] },
...
export const OWNED_STORES: OwnedStore[] = [
  ...
  store('FL', 'st-petersburg', 'St. Petersburg', '4500 4th St N, St. Petersburg, FL 33703', '(727) 390-3840', FL_HOURS, 27.81345, -82.63846),
